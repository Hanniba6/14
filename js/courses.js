...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (coursesList) {
        ...
        console.error("Could not find courses list container #courses-list! Please check HTML structure.");
    }
});
...
function loadCourses123() {
    ...
    if (!coursesContainer) {
        console.error("Could not find courses container element #courses-list");
        return;
    }
    ...
    if (displayCourses.length === 0) {
        coursesContainer.innerHTML = '<p class="no-data">No course data available</p>';
    }
